...
<div class="col-md-12 ptop--30 pbottom--30">
    ...
    <div class="post--items amthuc-moble" data-ajax-content="outer">
            ...
            ?>
                ...
                <li class="col-md-4 col-xs-6 col-xxs-12 ">
                    <div class="post--item post--layout-2">
                        <div class="post--img">
                            <a href="<?php the_permalink(); ?>" class="thumb"><img height="194px" src="<?php echo get_the_post_thumbnail_url($post_id, 'full'); ?>" alt="" data-rjs="2" data-rjs-processed="true"></a> <a href="#" class="cat"><?php $category = get_the_category();
    ...
    <div class="post--items amthuc-web" data-ajax-content="outer">
        <ul class="nav row gutter--15" data-ajax-content="inner">
            <?php
            $tin_tuc = new WP_Query(array(
                'post_type' => 'post',
