                ...
                ?>
                    <li>
                        <div class="post--item post--layout-2">
                            <div class="post--img">
                                <a href="<?php the_permalink(); ?>" class="thumb"><img class="image-xeco-1" src="<?php echo get_the_post_thumbnail_url($post_id, 'full'); ?>" alt="" data-rjs="2" data-rjs-processed="true"></a> <a href="#" class="cat"><?php $category = get_the_category(); echo get_primary_category($category); ?></a>
                                <div class="post--info">
                                    <ul class="nav meta">
